    ...
    if (fill_gaps) {
        ...
        */
        ...
        for (size_t pl_idx = 0; pl_idx < thick_polylines.size(); pl_idx++) {
            ...
            connection_endpoints.push_back({thick_polylines[pl_idx].points.front().cast<double>(), pl_idx, current_idx + 1, true});
            connection_endpoints.push_back({thick_polylines[pl_idx].points.back().cast<double>(), pl_idx, current_idx, false});
        }

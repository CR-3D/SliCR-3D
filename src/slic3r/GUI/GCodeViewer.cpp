...
GCodeViewer::GCodeViewer()
{
    //load Extrusion colors
    {
        ...
        this->Extrusion_Role_Colors[ExtrusionRole::erNone]              = { 0.50f, 0.50f, 0.50f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erPerimeter]         = { 0.80f, 0.60f, 0.20f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erExternalPerimeter] = { 0.80f, 0.30f, 0.10f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erOverhangPerimeter] = { 0.20f, 0.20f, 0.80f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erInternalInfill]    = { 0.50f, 0.10f, 0.10f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erInternalBridgeInfill] = { 0.60f, 0.20f, 0.20f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erSolidInfill]       = { 0.40f, 0.20f, 0.60f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erTopSolidInfill]    = { 0.70f, 0.20f, 0.20f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erIroning]           = { 0.80f, 0.40f, 0.30f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erBridgeInfill]      = { 0.70f, 0.30f, 0.50f, 1.0f };
        this->Extrusion_Role_Colors[ExtrusionRole::erOverhangInfill]    = { 0.20f, 0.40f, 0.60f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erThinWall]          = { 0.00f, 0.80f, 0.30f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erGapFill]           = { 0.80f, 0.80f, 0.80f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erSkirt]             = { 0.00f, 0.40f, 0.30f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erSupportMaterial]   = { 0.00f, 0.80f, 0.00f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erSupportMaterialInterface] = { 0.00f, 0.40f, 0.00f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erWipeTower]         = { 0.50f, 0.70f, 0.50f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erMilling]           = { 0.50f, 0.50f, 0.50f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erCustom]            = { 0.30f, 0.70f, 0.50f, 1.f };
        this->Extrusion_Role_Colors[ExtrusionRole::erMixed]             = { 0.10f, 0.10f, 0.10f, 1.f };
